#!/usr/bin/env python
"""chaostoolkit-instana extension builder and installer"""
...
def get_version_from_package() -> str:
    ...
    """
    path = os.path.join(os.path.dirname(__file__), "chaosinstana/__init__.py")
...
desc = 'Chaos Toolkit Instana Integration'
